...
class MainActivity : Activity(), EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewData = findViewById(R.id.textViewData) as TextView
        textViewStatus = findViewById(R.id.textViewStatus) as TextView
        checkBoxEAN8 = findViewById(R.id.checkBoxEAN8) as CheckBox
        checkBoxEAN13 = findViewById(R.id.checkBoxEAN13) as CheckBox
        checkBoxCode39 = findViewById(R.id.checkBoxCode39) as CheckBox
        checkBoxCode128 = findViewById(R.id.checkBoxCode128) as CheckBox
        checkBoxContinuous = findViewById(R.id.checkBoxContinuous) as CheckBox
        spinnerScannerDevices = findViewById(R.id.spinnerScannerDevices) as Spinner
        spinnerTriggers = findViewById(R.id.spinnerTriggers) as Spinner
    ...
    private fun addSpinnerTriggersListener() {
        ...
        spinnerTriggers!!.onItemSelectedListener = object : OnItemSelectedListener {
    ...
    private fun addStartScanButtonListener() {
        ...
        val btnStartScan = findViewById(R.id.buttonStartScan) as Button
    ...
    private fun addStopScanButtonListener() {
        ...
        val btnStopScan = findViewById(R.id.buttonStopScan) as Button
    ...
    private inner class AsyncDataUpdate : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            if (result != null) {
                ...
                (findViewById(R.id.scrollView1) as View).post { (findViewById(R.id.scrollView1) as ScrollView).fullScroll(View.FOCUS_DOWN) }
    ...
    private inner class AsyncUiControlUpdate : AsyncTask<Boolean, Void, Boolean>() {
        ...
        override fun onPostExecute(result: Boolean) {
            checkBoxEAN8!!.isEnabled = result
            checkBoxEAN13!!.isEnabled = result
            checkBoxCode39!!.isEnabled = result
            checkBoxCode128!!.isEnabled = result
            spinnerScannerDevices!!.isEnabled = result
            spinnerTriggers!!.isEnabled = result
        }
    ...
    override fun onConnectionChange(scannerInfo: ScannerInfo, connectionState: ConnectionState) {
        ...
        if (scannerName.compareTo(scannerNameExtScanner, ignoreCase = true) == 0) {
